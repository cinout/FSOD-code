...
def parse_args():
    ...
    parser.add_argument("--save_dir", dest="save_dir", required=True, help="save dir")
...
def main():
    ...
    info_list = np.concatenate(
        [ratio_index[:, np.newaxis], cls_list[:, np.newaxis]], axis=1
    )
    ...
    dataset = RoiDataLoader(
        roidb, cfg.MODEL.NUM_CLASSES, info_list, ratio_list, training=True
    )
    ...
    params = [
        ...
        {"params": box_outs_params, "lr": 0, "weight_decay": cfg.SOLVER.WEIGHT_DECAY},
    ]
